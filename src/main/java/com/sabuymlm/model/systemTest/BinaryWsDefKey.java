...
@Embeddable 
public class BinaryWsDefKey implements Serializable {
    ...
    public BinaryWsDefKey(){}
    public BinaryWsDefKey(Position position , Company company){
    ...
    public boolean equals(Object obj) {
        ...
        final BinaryWsDefKey other = (BinaryWsDefKey) obj;
