...
@Embeddable 
public class BinaryMultiWsDefKey implements Serializable {
    ...
    public BinaryMultiWsDefKey(){}
    public BinaryMultiWsDefKey(Position position , Company company){
    ...
    public boolean equals(Object obj) {
        ...
        final BinaryMultiWsDefKey other = (BinaryMultiWsDefKey) obj;
