...
@Embeddable 
public class MatchingDefKey implements Serializable {
    ...
    public MatchingDefKey(){}
    public MatchingDefKey(Integer levelIndex , Position position){
    ...
    public boolean equals(Object obj) {
        ...
        final MatchingDefKey other = (MatchingDefKey) obj;
