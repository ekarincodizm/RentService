...
@Embeddable 
public class UnilevelDefKey implements Serializable {
    ...
    public UnilevelDefKey(){}
    public UnilevelDefKey(Integer levelIndex , Position position){
    ...
    public boolean equals(Object obj) {
        ...
        final UnilevelDefKey other = (UnilevelDefKey) obj;
