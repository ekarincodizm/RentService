...
@Table(name = "sponsor_define_header", schema = "TestSystem" )
@Entity
@Transactional(readOnly = true)
public class SponsorDefineHeader implements Serializable {
    ...
    private List<SponsorDefine> items;
    ...
    public List<SponsorDefine> getItems() {
        return items;
    }

    public void setItems(List<SponsorDefine> items) {
        this.items = items;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SponsorDefineHeader other = (SponsorDefineHeader) obj;
